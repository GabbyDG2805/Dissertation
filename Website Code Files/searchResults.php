...
<html lang="en">
	...
	<head>
		...
		<title>Builds of Legends | Search Results</title>
	</head>
	...
	<body>
        <header>
            ...
            <div id="navigationBar">
                <ul id="navigation">
                    ...
                    <li class="navigationList"><a id="selected" class="nav" href="Guides.php">Browse Guides</a></li>
        ...
        <?php
            ...
            echo'<form action="searchResults.php" method="post">
						<input class="field" id="searchbar" type="text" name="search" placeholder="Search...">
			<button class="button" id="searchButton" type="submit" name="search-submit">Search</button>
			</form>';
            ...
            $sql = "SELECT * FROM guides WHERE GuideTitle LIKE '%$search%' OR Champion LIKE '%$search%' OR Patch LIKE '%$search%'";
                ...
                {
                    echo "Sorry, there are no results matching your search query";
                }
            }
        ?>
        </div>