...
<html lang="en">
	...
	<head>
		...
		<title>Builds of Legends | Your Profile</title>
	</head>
	...
	<body>
        <header>
            ...
            <div id="navigationBar">
                <ul id="navigation">
                    ...
                    <li class="navigationList"><a id="selected" class="nav" href="Profile.php">Profile</a></li>
                </ul>
            </div>
		</header>
		...
		<?php
			if(isset($_SESSION['UserID']))
			{
				...
				$server = $_SESSION['Region'];
				$sqlProf = "SELECT * FROM users WHERE Username = '$user' AND Region = '$server';";
				//Here we "query" the SQL statement in the database using our connection variable
					$resultProf = mysqli_query($connection, $sqlProf);
				//Here we get the number of results the query returned from the database
					$resultCheckProf = mysqli_num_rows($resultProf);

				//We then check if we had atleast 1 result from the database
					if ($resultCheckProf > 0) {
						while ($rowProf = mysqli_fetch_assoc($resultProf)) {
							$region = $rowProf['Region'];
							$rank = $rowProf['Division'];
							$level = $rowProf['Lvl'];
							echo'<div id="profileBio">
							<h1>'.$rowProf['Username'].'</h1>
							<div class="columnd"><img id="profilePic" src="Assets/Images/ProfilePics/Lil_Sprout_profileicon.png"></div>';
							if($region == 'EUW') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/EUW.png" alt="EUW"></div>';
							}
							else if($region == 'BR') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/BR.png" alt="BR"></div>';
							}
							else if($region == 'EUNE') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/EUNE.png" alt="EUNE"></div>';
							}
							else if($region == 'JP') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/JP.png" alt="JP"></div>';
							}
							else if($region == 'LAN') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/LAN.png" alt="LAN"></div>';
							}
							else if($region == 'LAS') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/LAS.png" alt="LAS"></div>';
							}
							else if($region == 'NA') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/NA.png" alt="NA"></div>';
							}
							else if($region == 'OCE') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/OCE.png" alt="OCE"></div>';
							}
							else if($region == 'RU') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/RU.png" alt="RU"></div>';
							}
							else if($region == 'TR') {
								echo '<div class="columnd"><img src="Assets/Images/Regions/TR.png" alt="TR"></div>';
							}
							if($rank == 'Unranked')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Unranked.png" alt="Unranked"></div>';
							}
							else if($rank == 'Iron')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Iron.png" alt="Iron"></div>';
							}
							else if($rank == 'Bronze')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Bronze.png" alt="Bronze"></div>';
							}
							else if($rank == 'Silver')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Silver.png" alt="Silver"></div>';
							}
							else if($rank == 'Gold')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Gold.png" alt="Gold"></div>';
							}
							else if($rank == 'Platinum')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Plat.png" alt="Platinum"></div>';
							}
							else if($rank == 'Diamond')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Diamond.png" alt="Diamond"></div>';
							}
							else if($rank == 'Master')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Master.png" alt="Master"></div>';
							}
							else if($rank == 'Grandmaster')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Grandmaster.png" alt="Grandmaster"></div>';
							}
							else if($rank == 'Challenger')
							{
								echo '<div class="columnd"><img src="Assets/Images/Ranks/Challenger.png" alt="Challenger"></div>';
							}
							if($level == 'Under 30')
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/U30.png" alt="Under level 30"></div>';
							}
							else if($level == '30-99')
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/30-99.png" alt="level 30-99"></div>';
							}
							else if($level == '100-199')
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/100-199.png" alt="level 100-199"></div>';
							}
							else if($level == '100-199')
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/100-199.png" alt="level 100-199"></div>';
							...
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/200-299.png" alt="level 200-299"></div>';
							}
							else if($level == '300-399')
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/300-399.png" alt="level 300-399"></div>';
							}
							else if($level == '400-499')
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/400-499.png" alt="level 400-499"></div>';
							}
							else if($level == '500+')
							{
								echo '<div class="columnd"><img src="Assets/Images/Levels/500+.png" alt="level 500+"></div>';
							}
							echo'<div class="columne"></div><div class="columne"><p>'.$rowProf['Region'].'</p></div>
							<div class="columne"><p>'.$rowProf['Division'].'</p></div>
							<div class="columne"><p>Lvl '.$rowProf['Lvl'].'</p></div>
							<a class="clickableLink" href="editProfile.php?UserID='.$rowProf['ID'].'"><button class="button" id="profile-button" name="profile-edit"><i class="fas fa-pencil-alt"></i> Edit Profile</button></a>
							</div>';
						}
					}
					echo'<h2 class=heading>My Guides</h2>';
					$build = [];
					$id = $_SESSION['UserID'];

				//Here we mix PHP and SQL in order to have a statement ready that we can refer to later on
				$sql = "SELECT * FROM guides WHERE AuthorID=$id;";
				//Here we "query" the SQL statement in the database using our connection variable
			...
			{
				echo '<p id="loginMsg">You must Log In to view your Profile.</p>';
			}
		?>
		</div>
